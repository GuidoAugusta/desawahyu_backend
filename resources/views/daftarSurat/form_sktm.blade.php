    ...
    <div class="h-full px-3 md:px-5 py-4 overflow-y-auto bg-white ">
      ...
      <form class="space-y-5 mt-8" action="/dashboard/sktm" method="POST" enctype="multipart/form-data">
        ...
        <div class="">
          ...
          <input type="text" id="nama" name="nama" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full  focus:ring-primary-100 focus:border-primary-100 p-2.5" required value="{{ old('nama') }}"/>
          @error('nama')
        ...
        <div class="">
          ...
          <input type="number" id="nik" name="nik" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full 0focus:ring-primary-100 focus:border-primary-100 p-2.5" required value="{{ old('nik') }}"/>
          @error('nik')
            <span class="text-red-500 text-sm">{{ $message }}</span>
          @enderror
        </div>
        ...
        <div class="">
          ...
          <select id="gender" name="jenis_kelamin" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  focus:ring-primary-100 block focus:border-primary-100 w-full p-2.5" required >
        ...
        <div class="">
          ...
          <input type="text" id="tempat" name="tempat" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full  focus:ring-primary-100 focus:border-primary-100 p-2.5 mb-5" required value="{{ old('tempat') }}" />
          @error('tempat')
            <span class="text-red-500 text-sm">{{ $message }}</span>
          @enderror
          <input type="date" id="tanggal" name="tanggal_lahir" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full  focus:ring-primary-100 focus:border-primary-100 p-2.5" required value="{{ old('tanggal_lahir') }}" />
          @error('tanggal_lahir')
            <span class="text-red-500 text-sm">{{ $message }}</span>
          @enderror
        </div>
        ...
        <div class="">
          ...
          <input type="text" id="agama" name="agama" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full  focus:ring-primary-100 focus:border-primary-100 p-2.5" required value="{{ old('agama') }}"/>
          @error('agama')
            <span class="text-red-500 text-sm">{{ $message }}</span>
          @enderror
        </div>
        ...
        <div class="">
          ...
          <input type="text" id="pekerjaan" name="pekerjaan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full  focus:ring-primary-100 focus:border-primary-100 p-2.5" required value="{{ old('pekerjaan') }}"/>
          @error('pekerjaan')
            <span class="text-red-500 text-sm">{{ $message }}</span>
          @enderror
        </div>
        ...
        <div class="">
          ...
          <input type="text" id="alamat" name="alamat" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full  focus:ring-primary-100  focus:border-primary-100 p-2.5" required value="{{ old('alamat') }}"/>
          @error('alamat')
            <span class="text-red-500 text-sm">{{ $message }}</span>
          @enderror
        </div>
        ...
        <div class="">
          ...
          <input type="email" id="email" name="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full  focus:ring-primary-100  focus:border-primary-100 p-2.5 read-only" value="{{ Auth::user()->email }}" required value="{{ old('email') }}"/>
          @error('email')
            <span class="text-red-500 text-sm">{{ $message }}</span>
          @enderror
        </div>
        <div class="">
          ...
          <input type="file" id="ktp" name="ktp" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full focus:ring-primary-100  focus:border-primary-100" required/>
          @error('ktp')
            <span class="text-red-500 text-sm">{{ $message }}</span>
          @enderror
        </div> 
        <div class="">
          <button type="submit" class="text-white bg-primary-100 focus:ring-2 focus:outline-none focus:ring-primary-100 font-medium rounded-lg text-sm block w-full px-5 py-2.5 text-center">Submit</button>
        </div>
      </form>
    </div>
  </aside>
