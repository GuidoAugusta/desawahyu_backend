<x-layout>
    ...
    <section class="py-8">
      <div class="container mx-auto space-y-3">
       <div class="bg-primary-200 p-4 flex">
        <svg xmlns="http://www.w3.org/2000/svg" width="50px" height="30px" viewBox="0 0 24 24"><path fill="white" d="M10 19v-5h4v5c0 .55.45 1 1 1h3c.55 0 1-.45 1-1v-7h1.7c.46 0 .68-.57.33-.87L12.67 3.6c-.38-.34-.96-.34-1.34 0l-8.36 7.53c-.34.3-.13.87.33.87H5v7c0 .55.45 1 1 1h3c.55 0 1-.45 1-1"/></svg>
        <a href="#">
            <h1 class="text-white font-normal text-xl hover:text-black transition ease-in-out duration-300 ">/ Struktur Organisasi</h1>
        </a>
       </div>
      </div>
    </section>
    ...
    <section class="md:flex py-4">
        <div class="px-8 md:w-5/12">
         ...
         <div>
            <div class="flex space-x-2 space-y-0 display-on-check text-decoration-none cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg"   width="25px"  height="25px" viewBox="0 0 9 16"><path fill="black" d="M7.62 7.18L2.79 3.03c-.7-.6-1.79-.1-1.79.82v8.29c0 .93 1.09 1.42 1.79.82l4.83-4.14c.5-.43.5-1.21 0-1.64"/></svg>
