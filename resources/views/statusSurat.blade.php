<x-layout>
  ...
  <div class="container mx-auto mt-20">
    ...
    <div id="alert" class="md:w-1/2 md:mx-auto mx-2 flex items-center p-4 mb-4 text-green-800 rounded-lg bg-green-200 dark:bg-gray-800 dark:text-green-400" role="alert">
    ...
    <div id="alert" class="md:w-1/2 md:mx-auto mx-2 flex items-center p-4 mb-4 text-red-800 rounded-lg bg-red-200 transition-all duration-700" role="alert">
      <svg class="flex-shrink-0 w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
        <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z"/>
      </svg>
      <span class="sr-only">Info</span>
              ...
              <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800">
                  ...
                  <td class="px-6 py-4">
                    @if ($item->jenis_surat == 'Surat Keterangan Tidak Mampu')
                      <a href="/cetak/sktm/{{ $item->id }}" class="font-medium text-blue-600 hover:underline">Cetak</a> | 
                    @elseif ($item->jenis_surat == 'jenis_lain')
                      <a href="" class="font-medium text-blue-600 hover:underline">Cetak</a> | 
                    @endif

                    @if ($item->jenis_surat == 'Surat Keterangan Tidak Mampu')
                    <form action="/hapus/sktm/{{ $item->id }}" method="POST" class="inline">
                      @csrf
                      @method('DELETE')
