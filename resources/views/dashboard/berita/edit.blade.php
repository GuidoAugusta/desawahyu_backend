<x-layout>
    ...
    <div class="p-4 sm:ml-64">
        <h1 class="text-4xl mb-10">Edit Berita👋!!</h1>
    </div>

    <form class="max-w-4xl mx-auto px-5 mb-10" method="post" action="/dashboard/berita/{{ $berita->slug }}"
            ...
            @if ($berita->image)
                <div class="grid grid-cols-12 gap-4">
                    <img src="{{ asset('storage/' . $berita->image) }}"
                        class="img-preview img-fluid mb-3 col-span-12 sm:col-span-5">
                </div>
            @else
                <div class="grid grid-cols-12 gap-4">
